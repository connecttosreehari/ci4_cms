                ...
                <div class="col-sm-6">
                    <?php if ($languages && count($languages) > 1) : ?>
                        <div class="dropdown show float-right">
                            <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="<?= $content_language->title ?>">
                                <?= $content_language->code ?>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="min-width:4em;">
                                <a class="dropdown-item active" href="<?= base_url(route_to('contents_add', $content_group->id, $content_language->id, null)) ?>">None</a>
                                <?php foreach ($languages as $language) : ?>
                                    <a class="dropdown-item <?= $language->code == $content_language->code ? 'active' : '' ?>" href="<?= base_url(route_to('contents_edit', $content->id, $language->code, $content_form_group->id)) ?>" title="<?= $language->title ?>"><?= $language->code ?></a>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    <?php endif; ?>
        ...
        <div class="card card-primary">
            <?php if (!empty($content_subtitle)) : ?>
                <div class="card-header">
                    ...
                    <div class="float-right "><span>ID: <?=$content->id?></span></div>
                </div>
            <?php endif; ?>
            <div class="card-body">
                <form method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="dropdown show">
                                ...
                                <div class="dropdown-menu" aria-labelledby="custom_form_group" style="min-width:4em;">
                                    <?php foreach ($form_groups as $form_group) : ?>
                                        <a class="dropdown-item <?= $custom_form_group_id > 0 && $form_group->id == $content_form_group->id ? 'active' : '' ?>" href="<?= base_url(route_to('contents_edit_custom_form', $content->id, $content_language->code, $form_group->id)) ?>"><?= $form_group->title ?></a>
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php if (!empty($content_fields['title']['settings']) && $content_fields['title']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  <?= $content_language->direction == 'rtl' ? 'direction-rtl' : 'direction-ltr' ?> <?= $validation->hasError('title') ? 'is-invalid' : '' ?>" id="title" name="title" placeholder="Title" value="<?= set_value('title', !empty($content_translation->title) ? $content_translation->title : '') ?>" onkeyup="slugify_text(this,'slug')">
                    ...
                    <?php if (!empty($content_fields['slug']['settings']) && $content_fields['slug']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  <?= $content_language->direction == 'rtl' ? 'direction-rtl' : 'direction-ltr' ?>  <?= $validation->hasError('slug') ? 'is-invalid' : '' ?>" id="slug" name="slug" placeholder="Slug" value="<?= set_value('slug', !empty($content_translation->slug) ? $content_translation->slug : '') ?>">
                    ...
                    <?php if (!empty($content_fields['subtitle']['settings']) && $content_fields['subtitle']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control   <?= $content_language->direction == 'rtl' ? 'direction-rtl' : 'direction-ltr' ?> <?= $validation->hasError('subtitle') ? 'is-invalid' : '' ?>" id="subtitle" name="subtitle" placeholder="Subtitle" value="<?= set_value('subtitle', !empty($content_translation->subtitle) ? $content_translation->subtitle : '') ?>">
                    ...
                    <?php if (!empty($content_fields['full_name']['settings']) && $content_fields['full_name']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  <?= $content_language->direction == 'rtl' ? 'direction-rtl' : 'direction-ltr' ?>  <?= $validation->hasError('full_name') ? 'is-invalid' : '' ?>" id="full_name" name="full_name" placeholder="Full Name" value="<?= set_value('full_name', !empty($content_translation->full_name) ? $content_translation->full_name : '') ?>">
                    ...
                    <?php if (!empty($content_fields['address']['settings']) && $content_fields['address']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <textarea class="form-control  <?= $content_language->direction == 'rtl' ? 'direction-rtl' : 'direction-ltr' ?>  <?= $validation->hasError('address') ? 'is-invalid' : '' ?>" id="address" name="address" placeholder="Address"><?= set_value('address', !empty($content_translation->address) ? $content_translation->address : '') ?></textarea>
                    ...
                    <?php if (!empty($content_fields['email']['settings']) && $content_fields['email']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('email') ? 'is-invalid' : '' ?>" id="email" name="email" placeholder="Email" value="<?= set_value('email', !empty($content_translation->email) ? $content_translation->email : '') ?>">
                    ...
                    <?php if (!empty($content_fields['phone']['settings']) && $content_fields['phone']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('phone') ? 'is-invalid' : '' ?>" id="phone" name="phone" placeholder="Phone" value="<?= set_value('phone', !empty($content_translation->phone) ? $content_translation->phone : '') ?>">
                    ...
                    <?php if (!empty($content_fields['fax']['settings']) && $content_fields['fax']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('fax') ? 'is-invalid' : '' ?>" id="fax" name="fax" placeholder="Fax" value="<?= set_value('fax', !empty($content_translation->fax) ? $content_translation->fax : '') ?>">
                    ...
                    <?php if (!empty($content_fields['short_description']['settings']) && $content_fields['short_description']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <textarea class="form-control  <?= $content_language->direction == 'rtl' ? 'direction-rtl' : 'direction-ltr' ?> <?= $content_fields['short_description']['settings']->enable_editor == 1 ? 'summernote' : '' ?> <?= $validation->hasError('short_description') ? 'is-invalid' : '' ?>" id="short_description" name="short_description" placeholder="Short Description"><?= set_value('short_description', !empty($content_translation->short_description) ? $content_translation->short_description : '') ?></textarea>
                    ...
                    <?php if (!empty($content_fields['description']['settings']) && $content_fields['description']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <textarea class="form-control  <?= $content_language->direction == 'rtl' ? 'direction-rtl' : 'direction-ltr' ?>  <?= $content_fields['description']['settings']->enable_editor == 1 ? 'summernote' : '' ?>  <?= $validation->hasError('description') ? 'is-invalid' : '' ?>" id="description" name="description" placeholder="Description"><?= set_value('description', !empty($content_translation->description) ? $content_translation->description : '') ?></textarea>
                    ...
                    <?php if (!empty($content_fields['image_upload']['settings']) && $content_fields['image_upload']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <br /><?= $validation->showError('image_upload[]', 'error') ?>
                        </div>
                        <div class="row">
                            <?php
                                    ...
                                    <div class="col-2">
                                        <div class="card bg-light d-flex flex-fill">
                                            ...
                                            <div class="card-footer">
                                                <?php if ($content_fields['image_upload']['settings']->enable_file_order == 1) : ?>
                                                    <div class="float-left">
                                                        <input type="text" name="file_order_<?= $file_detail->id ?>" value="<?= $file_detail->file_order ?>" class="text-center form-control-sm" style="width:40px;" title="File Order">
                                                    </div>
                                                <?php endif; ?>
                                                <div class="float-right">
                                                    <?php if ($content_fields['image_upload']['settings']->enable_file_edit == 1) : ?>
                                                        <a href="<?= base_url(route_to('contents_file_edit', $file_detail->id, $file_detail->content_id, $content_fields['image_upload']['settings']->id, $file_detail->language)) ?>" class="btn btn-sm bg-teal" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                    <?php endif; ?>
                                                    <?php if ($content_fields['image_upload']['settings']->enable_file_delete == 1) : ?>
                                                        <a href="#" class="btn btn-sm btn-danger confirm-button" title="Delete" data-msg="Are you sure want to delete this image?" data-href="<?= base_url(route_to('contents_file_delete', $file_detail->id, $file_detail->content_id, $content_fields['image_upload']['settings']->id, $file_detail->language)) ?>" data-toggle="modal" data-target="#modal-confirm"><i class="fa fa-trash"></i></a>
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                    ...
                    <?php if (!empty($content_fields['document_upload']['settings']) && $content_fields['document_upload']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <br /><?= $validation->showError('document_upload[]', 'error') ?>
                        </div>
                        <div class="row">
                            <?php
                                    ...
                                    <div class="col-3">
                                        <div class="card d-flex flex-fill">
                                            <div class="card-body pt-2 pb-2">
                                                ...
                                                <?php if ($content_fields['document_upload']['settings']->enable_file_delete == 1) : ?>
                                                    <a href="#" class="btn btn-sm btn-danger float-right confirm-button" title="Delete" data-msg="Are you sure want to delete this image?" data-href="<?= base_url(route_to('contents_file_delete', $file_detail->id, $file_detail->content_id, $content_fields['document_upload']['settings']->id, $file_detail->language)) ?>" data-toggle="modal" data-target="#modal-confirm"><i class="fa fa-trash"></i></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <?php if (!empty($content_fields['link']['settings']) && $content_fields['link']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('link') ? 'is-invalid' : '' ?>" id="link" name="link" placeholder="Link" value="<?= set_value('link', !empty($content_translation->link) ? $content_translation->link : '') ?>">
                    ...
                    <?php if (!empty($content_fields['button_name']['settings']) && $content_fields['button_name']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control   <?= $content_language->direction == 'rtl' ? 'direction-rtl' : 'direction-ltr' ?>  <?= $validation->hasError('button_name') ? 'is-invalid' : '' ?>" id="button_name" name="button_name" placeholder="Button Name" value="<?= set_value('button_name', !empty($content_translation->button_name) ? $content_translation->button_name : '') ?>">
                    ...
                    <?php if (!empty($content_fields['icon']['settings']) && $content_fields['icon']['settings']->active == 1) : ?>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= $validation->hasError('icon') ? 'is-invalid' : '' ?>" id="icon" name="icon" placeholder="Icon" value="<?= set_value('icon', !empty($content_translation->icon) ? $content_translation->icon : '') ?>">
                    ...
                    <?php if ((!empty($content_fields['meta_title']['settings']) && $content_fields['meta_title']['settings']->active == 1)
                        ...
                        <?php if (!empty($content_fields['meta_title']['settings']) && $content_fields['meta_title']['settings']->active == 1) : ?>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control <?= $validation->hasError('meta_title') ? 'is-invalid' : '' ?>" id="meta_title" name="meta_title" placeholder="Title" value="<?= set_value('meta_title', !empty($content_translation->meta_title) ? $content_translation->meta_title : '') ?>">
                        ...
                        <?php if (!empty($content_fields['meta_keyword']['settings']) && $content_fields['meta_keyword']['settings']->active == 1) : ?>
                            <div class="form-group">
                                ...
                                <textarea class="form-control  <?= $validation->hasError('meta_keyword') ? 'is-invalid' : '' ?>" id="meta_keyword" name="meta_keyword" placeholder="Meta Keyword"><?= set_value('meta_keyword', !empty($content_translation->meta_keyword) ? $content_translation->meta_keyword : '') ?></textarea>
                        ...
                        <?php if (!empty($content_fields['meta_description']['settings']) && $content_fields['meta_description']['settings']->active == 1) : ?>
                            <div class="form-group">
                                ...
                                <textarea class="form-control <?= $validation->hasError('meta_description') ? 'is-invalid' : '' ?>" id="meta_description" name="meta_description" placeholder="Meta Description"><?= set_value('meta_description', !empty($content_translation->meta_description) ? $content_translation->meta_description : '') ?></textarea>
                        ...
                        <?php if (!empty($content_fields['meta_canonical_url']['settings']) && $content_fields['meta_canonical_url']['settings']->active == 1) : ?>
                            <div class="form-group">
                                ...
                                <textarea class="form-control <?= $validation->hasError('meta_canonical_url') ? 'is-invalid' : '' ?>" id="meta_canonical_url" name="meta_canonical_url" placeholder="Canonical URL"><?= set_value('meta_canonical_url', !empty($content_translation->meta_canonical_url) ? $content_translation->meta_canonical_url : '') ?></textarea>
